    ...
    CreateThread(function()
        ...
        exports.ox_target:addBoxZone({
            ...
            size = vector3(
                ...
                Oilwell_config.TruckWithdraw.box.maxz_offset - Oilwell_config.TruckWithdraw.box.minz_offset
            ),
...
AddEventHandler('keep-oilwell:client:refund_truck', function(data)
    ...
    local spawnLocation = vector3(
        Oilwell_config.Delivery.SpawnLocation.x,
        Oilwell_config.Delivery.SpawnLocation.y,
